...
export const LandingPage: React.FC<LandingPageProps> = ({ onLaunchDemo }) => {
  ...
  return (
    <div className="min-h-screen bg-neutral-950 text-neutral-100 antialiased selection:bg-orange-500 selection:text-white font-sans overflow-x-hidden">
      ...
      {/* Top Header Navbar */}
      <header className="fixed top-0 left-0 right-0 z-50 px-4 sm:px-8 py-3.5 bg-neutral-950/80 backdrop-blur-md border-b border-neutral-800/60">
        <div className="max-w-7xl mx-auto flex items-center justify-between">
          <div className="flex items-center gap-3">
            <div className="w-8 h-8 rounded-lg bg-neutral-900 border border-neutral-700/80 flex items-center justify-center text-orange-400 font-mono font-bold text-sm shadow-md">
              D
            </div>
            <div className="flex items-center gap-2">
              <span className="font-bold text-sm sm:text-base tracking-tight text-white">Decision Log</span>
              <span className="text-[10px] font-mono uppercase px-2 py-0.5 rounded bg-orange-500/10 border border-orange-500/20 text-orange-400 hidden sm:inline-block">
          ...
          <div className="flex items-center gap-3">
            ...
            <button
              ...
              className="btn-orange-glow inline-flex items-center gap-1.5 px-4 py-2 rounded-lg bg-orange-500 hover:bg-orange-600 text-neutral-950 font-bold text-xs uppercase tracking-wider transition-all cursor-pointer shadow-lg shadow-orange-500/20"
            >
      ...
      {/* Hero Section */}
      <section id="overview" className="relative min-h-[92vh] flex flex-col justify-between pt-28 pb-12 overflow-hidden border-b border-neutral-900 z-10">
        
        {/* Subtle Ambient Backlight */}
        <div className="absolute top-1/3 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[800px] h-[450px] bg-gradient-to-r from-orange-500/15 via-amber-500/5 to-transparent blur-[140px] rounded-full pointer-events-none" />
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-8 w-full flex-1 flex flex-col justify-between relative z-10">
          ...
          <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-3 border-b border-neutral-900 pb-4">
            <div className="flex items-center gap-2 text-xs font-mono text-neutral-400 bg-neutral-900/80 px-3 py-1.5 rounded-full border border-neutral-800">
              <span className="text-orange-400 font-bold">#</span>
              <span>DECISION LOG — THE INSTITUTIONAL MEMORY ENGINE</span>
            </div>
            <div className="flex items-center gap-2 text-xs font-mono text-neutral-400 bg-neutral-900/80 px-3 py-1.5 rounded-full border border-neutral-800">
              <span className="relative flex h-2 w-2">
                <span className="animate-ping absolute inline-flex h-full w-full rounded-full bg-emerald-400 opacity-75"></span>
          ...
          {/* Hero Main Content */}
          <div className="my-auto py-8 sm:py-12 grid grid-cols-1 lg:grid-cols-12 gap-10 sm:gap-14 items-center">
            ...
            <div className="lg:col-span-7 space-y-6">
              <div className="space-y-3">
                ...
                <h1 className="text-3xl sm:text-6xl lg:text-7xl font-bold tracking-tight text-white leading-[1.1]">
                  Decision Records <br />
              ...
              <div className="pt-3 flex flex-col sm:flex-row flex-wrap items-stretch sm:items-center gap-3">
                <button
                  onClick={onLaunchDemo}
                  className="btn-orange-glow inline-flex items-center justify-center gap-2 px-7 py-4 rounded-xl bg-orange-500 hover:bg-orange-600 text-neutral-950 font-bold text-xs sm:text-sm uppercase tracking-wider transition-all cursor-pointer shadow-xl shadow-orange-500/25"
                >
                ...
                <a
                  href="#system"
                  className="inline-flex items-center justify-center gap-2 px-6 py-4 rounded-xl bg-neutral-900 border border-neutral-800 hover:border-neutral-700 text-neutral-300 hover:text-white font-semibold text-xs sm:text-sm uppercase tracking-wider transition-all"
                >
              ...
              <div className="bg-neutral-900/80 rounded-2xl overflow-hidden border border-neutral-800 shadow-2xl">
                ...
                <div className="bg-neutral-950 px-4 py-3 border-b border-neutral-800 flex items-center justify-between">
                  <div className="flex items-center gap-2">
                    ...
                    <span className="ml-2 text-xs font-mono text-neutral-400">adr/DEC-042.ts</span>
                  </div>

                  <button
                    onClick={handleCopyCode}
                    className="text-neutral-400 hover:text-white text-xs font-mono flex items-center gap-1.5 px-2.5 py-1 rounded bg-neutral-900 border border-neutral-800 transition cursor-pointer"
                  >
                ...
                {/* Sub-tabs */}
                <div className="bg-neutral-900 px-3 py-2 border-b border-neutral-800/80 flex items-center gap-1.5 overflow-x-auto text-[11px] font-mono">
                  <button
                ...
                {/* Code Body */}
                <div className="p-4 bg-neutral-950 font-mono text-xs text-neutral-300 overflow-x-auto min-h-[220px] max-h-[260px] leading-relaxed">
                  {activeCodeTab === 'decision' && (
...
&#125;;</code></pre>
                ...
                {/* Status bottom bar */}
                <div className="bg-neutral-950 px-4 py-2.5 border-t border-neutral-800 flex items-center justify-between text-[11px] font-mono text-neutral-400">
          ...
          {/* Bottom KPI Bar */}
          <div className="pt-6 border-t border-neutral-900 grid grid-cols-2 md:grid-cols-4 gap-4 sm:gap-6 font-mono">
            <div className="p-4 rounded-xl bg-neutral-900/60 border border-neutral-800/80 hover:border-orange-500/40 transition-colors">
              <div className="text-2xl sm:text-3xl font-bold text-white font-mono">0 hrs</div>
              <div className="text-[10px] sm:text-xs text-neutral-400 uppercase tracking-wider mt-1">Slack Search Lost</div>
            </div>
            <div className="p-4 rounded-xl bg-neutral-900/60 border border-neutral-800/80 hover:border-orange-500/40 transition-colors">
              <div className="text-2xl sm:text-3xl font-bold text-orange-400 font-mono">100%</div>
              <div className="text-[10px] sm:text-xs text-neutral-400 uppercase tracking-wider mt-1">SOC2 Audit Ready</div>
            </div>
            <div className="p-4 rounded-xl bg-neutral-900/60 border border-neutral-800/80 hover:border-orange-500/40 transition-colors">
              <div className="text-2xl sm:text-3xl font-bold text-white font-mono">4.2x</div>
              <div className="text-[10px] sm:text-xs text-neutral-400 uppercase tracking-wider mt-1">Faster Onboarding</div>
            </div>
            <div className="p-4 rounded-xl bg-neutral-900/60 border border-neutral-800/80 hover:border-orange-500/40 transition-colors">
              <div className="text-2xl sm:text-3xl font-bold text-emerald-400 font-mono">&lt; 30s</div>
        ...
        <div className="animate-marquee space-x-6 flex items-center">
          {[...TECH_TAPE, ...TECH_TAPE, ...TECH_TAPE].map((tech, idx) => {
            ...
            return (
              <div
                key={idx}
                className="flex items-center gap-2 px-4 py-1.5 rounded-full bg-neutral-900/60 border border-neutral-800 text-neutral-300 text-xs font-mono tracking-wider hover:border-orange-500/50 hover:text-white transition-colors shrink-0"
              >
      ...
      <section id="system" className="py-24 bg-neutral-950 text-white relative z-10 border-t border-neutral-900">
        <div className="max-w-7xl mx-auto px-4 sm:px-8">
          ...
          {/* 3 Pillar Cards with Signature Orange Glow */}
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            
            <div className="orange-card-hover relative flex flex-col justify-between min-h-[320px] p-7 rounded-2xl border border-neutral-800/80 bg-neutral-900/40">
              ...
              <div className="my-6 space-y-2">
                ...
                <h3 className="text-lg font-bold text-white">Binding Decision Statement</h3>
            ...
            <div className="orange-card-hover relative flex flex-col justify-between min-h-[320px] p-7 rounded-2xl border border-neutral-800/80 bg-neutral-900/40">
              ...
              <div className="my-6 space-y-2">
                ...
                <h3 className="text-lg font-bold text-white">Rejected Alternatives Log</h3>
                <p className="text-xs text-neutral-400 leading-relaxed">
            ...
            <div className="orange-card-hover relative flex flex-col justify-between min-h-[320px] p-7 rounded-2xl border border-neutral-800/80 bg-neutral-900/40">
              ...
              <div className="my-6 space-y-2">
                ...
                <h3 className="text-lg font-bold text-white">Superseded Lineage Link</h3>
                <p className="text-xs text-neutral-400 leading-relaxed">
      ...
      <section className="py-20 border-t border-neutral-900 bg-neutral-950">
        <div className="max-w-5xl mx-auto px-4 sm:px-8">
          <div className="p-8 sm:p-14 rounded-3xl bg-neutral-900/60 border border-neutral-800 text-center relative overflow-hidden space-y-5">
            ...
            <div className="pt-2">
              <button
                onClick={onLaunchDemo}
                className="btn-orange-glow inline-flex items-center gap-2 px-8 py-4 rounded-xl bg-orange-500 hover:bg-orange-600 text-neutral-950 font-bold text-xs sm:text-sm uppercase tracking-wider transition-all cursor-pointer shadow-xl shadow-orange-500/30"
              >
      ...
      {/* Footer */}
      <footer className="border-t border-neutral-900 py-8 px-6 text-xs font-mono text-neutral-500">
        <div className="max-w-7xl mx-auto flex flex-col sm:flex-row items-center justify-between gap-4">
          ...
          <p>&copy; {new Date().getFullYear()} Decision Log. Systems Architecture & Records.</p>
        </div>
      </footer>
    </div>
  );
